#!/usr/bin/env python3
"""
Convert the better Bitcoin logo to LVGL format
"""
import struct

def convert_better_logo():
    # Read the BMP file
    ...
    c_array = "// Bitcoin logo 48x48 RGB565\n"
    ...
    print("Better Bitcoin logo converted to LVGL C format!")
